package ch11.homework02.exam05;
...
public class DateTimeCompareExample {
	...
	public static void main(String[] args) {
		...
		System.out.println("남은달 :"+remainMonth);
		System.out.println("남은일 :"+remainDay);
		System.out.println("남은시간 :"+remainHour);
		...
		System.out.print("남은 기간"+period.getMonths()+"월 ");
		System.out.print("남은 기간"+period.getDays()+"일\n ");
