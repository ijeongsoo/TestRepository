...
public class HttpActivity extends AppCompatActivity {
    ...
    public void handleBtnGet(View v) throws IOException {
        String url ="http://192.168.3.129:8080/IoTWebProgramming/http/exam03";
    ...
    private boolean checkPermission(){
        ...
        if (permissionREX != PackageManager.PERMISSION_GRANTED || permissionWEX != PackageManager.PERMISSION_GRANTED) {
    ...
    public void handleBtnMultipart(View v) {
        ...
        String url="http://192.168.3.129:8080/IoTWebProgramming/http/exam04";
    ...
    public void handleBtnWebSocketOpen(View v) {
        String url = "ws://192.168.3.129:8080/SensingCarRemoteControl/websocket/thermistorSensor";
        Request request=new Request.Builder()
                .url(url)
                .build();
    ...
    public void handleBtnChangAngle(View view){
        String url = "http://192.168.3.129:8080/SensingCarRemoteControl/ultrasonicSensor";
        HttpUrl httpUrl=HttpUrl.parse(url).newBuilder()
