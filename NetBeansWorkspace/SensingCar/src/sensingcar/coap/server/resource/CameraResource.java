...
public class CameraResource extends CoapResource{
	...
	public void handlePOST(CoapExchange exchange) {
		...
		try{
			...
			responseJsonObject.put("leftright", String.valueOf(currentLeftRight));
			responseJsonObject.put("updown", String.valueOf(currentUpDown));
