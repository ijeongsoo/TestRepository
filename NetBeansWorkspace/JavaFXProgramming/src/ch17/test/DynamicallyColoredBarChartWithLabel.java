...
/**
 * Displays a bar with a single series whose bars are different colors depending upon the bar value. A custom legend is created and displayed for the bar data. Bars in the chart are customized to include a text label of the bar's data value above the bar.
 */
public class DynamicallyColoredBarChartWithLabel extends Application {
	...
	public void start(Stage stage) {
		...
		CustomBarChart bc = new CustomBarChart(xAxis, yAxis);
