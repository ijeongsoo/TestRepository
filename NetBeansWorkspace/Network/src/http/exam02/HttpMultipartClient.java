...
public class HttpMultipartClient {
	...
	public static void main(String[] args) throws IOException {
		...
		try {
			...
			File attach = new File("/Users/ijeongsu/Desktop/사진.png");
			FileBody attachBody = new FileBody(attach, ContentType.create("image/jpeg"));

			HttpPost httpPost = new HttpPost("http://192.168.3.129:8080/IoTWebProgramming/http/exam02");
			...
			//파일 파트 
			multipartEntityBuilder.setCharset(Charset.forName("UTF-8")); // 파일 이름이 한글이 포함 되어 있을 경우 
